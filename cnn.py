...
classifier.add(Conv2D(45, (3,3), input_shape = (64,64,3), activation = 'relu'))
...
training_set = train_datagen.flow_from_directory(currentDirectory + '/data/test', target_size = (64, 64), batch_size = 32, class_mode = 'binary')
